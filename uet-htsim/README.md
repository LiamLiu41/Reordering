...
For SING-specific onboarding (architecture, module relations, and CC regression usage), see:
- [discussion/SING_QUICKSTART_GUIDE.md](discussion/SING_QUICKSTART_GUIDE.md)
