...
typedef enum {IP, TCP, TCPACK, TCPNACK, SWIFT, SWIFTACK, STRACK, STRACKACK,
              ...
              SINGDATA, SINGACK, SINGNACK, SINGCNP} packet_type;
...
class Packet {
 ...
 public:
    ...
    typedef enum {
        PRIO_LO = 0, PRIO_MID = 1, PRIO_HI = 2, PRIO_NONE = 3,
        PRIO_3 = 4, PRIO_4 = 5, PRIO_5 = 6, PRIO_6 = 7, PRIO_7 = 8,
    } PktPriority;
    static constexpr int NUM_PRIOS = 8;
