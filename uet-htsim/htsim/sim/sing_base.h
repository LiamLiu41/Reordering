...
class SingMsgTracker {
public:
    /*
    * Return next packet and keep track of its status internally.
    */
    virtual mem_b getNextPacket(SingDataPacket::seq_t seq_no) = 0;
    /*
    * Notify of seq no of dataless control packet
    */
    virtual void notifyCtrlSeqno(SingDataPacket::seq_t seq_no) = 0;
    /*
    * Track received packets. If this sequence number completed the
    * receiving of a message, its message id is returned.
    */
    virtual void addRecvd(SingDataPacket::seq_t seq_no) = 0;
    /*
    * Handle continuous acks
    */
    virtual void addCumAck(SingDataPacket::seq_t cum_ack) = 0;
    /*
    * Handle selective acks
    */
    virtual void addSAck(SingDataPacket::seq_t ackno) = 0;
    /*
    ...
    */
    ...
    virtual ~SingMsgTracker() = default;
};


class SingTransportConnection {
public:
    /*
     Make the connection reusable and set a connection tracker.
    */
    virtual void makeReusable(SingMsgTracker* conn_reuse_tracker) = 0;
    /*
    */
    ...
    */
    ...
    virtual ~SingTransportConnection() = default;
};
